package com.ysmjjsy.goya.juc.rwlock;
...
public class StampedLockDemo {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            writeThread	=====写线程准备修改
            writeThread	=====写线程结束修改
            readThread	 正在读取中......2秒后stampedLock.validate值(true无修改，false有修改)	false
            readThread	 正在读取中......3秒后stampedLock.validate值(true无修改，false有修改)	false
            readThread	 正在读取中......4秒后stampedLock.validate值(true无修改，false有修改)	false
            有人动过--------存在写操作！
            从乐观读 升级为 悲观读并重新获取数据
            重新悲观读锁通过获取到的成员变量值result：50
