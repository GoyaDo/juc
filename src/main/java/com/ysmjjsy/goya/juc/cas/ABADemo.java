...
public class ABADemo {
    ...
    public static void main(String[] args) {
        ...
        new Thread(()->{
            ...
            boolean result = atomicStampedReference.compareAndSet(100, 522, stamp, stamp + 1);
    ...
    private static void adaProblem() {
        new Thread(() -> {
        ...
        new Thread(() -> {
            boolean b = atomicInteger.compareAndSet(100, 522);
